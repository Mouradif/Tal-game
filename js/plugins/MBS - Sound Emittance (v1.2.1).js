...
(function ($) {
	...
	Game_SoundEmittance.prototype.initialize = function(filename) {
		...
		this.volume = AudioManager.seVolume / 100;
		this.pitch = 1;
		this.playing = false;
		this.playParameters = [];
		this.maxDistance = 1;
	...
	Game_Event.prototype.setupSEmittance = function() {
		if (this._sEmittance && typeof this._sEmittance.stop === 'function') {
		...
		if (volume && this._sEmittance)
			this._sEmittance.volume = this._sEmittance.volume * (volume / 100);
	...
	Game_Event.prototype.updateSEmittance = function() {
		if (this._sEmittance && typeof this._sEmittance.play === 'function') {
